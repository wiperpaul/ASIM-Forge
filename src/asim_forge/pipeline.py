...
def build_review_bundle(
    ...
    *,
    ...
    rankings_path = output_dir / "schema-rankings.jsonl"
    ...
    potato_items, potato_config = write_potato_bundle(clustering.clusters, output_dir)
    manifest = BuildManifest(
        ...
        masks=clustering.masks,
        outputs={
            "clusters": clusters_path.relative_to(output_dir).as_posix(),
            "schema_rankings": rankings_path.relative_to(output_dir).as_posix(),
